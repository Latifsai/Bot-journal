...
public class UserUtil {
    ...
    public User createUser(Message message) {
        ...
        user.setFirstname(constraint(chat.getFirstName()) ? Messages.PARAMETER_NOT_EXISTS_MESSAGE : chat.getFirstName());
        user.setUsername(constraint(chat.getUserName()) ? Messages.PARAMETER_NOT_EXISTS_MESSAGE : chat.getUserName());
        user.setLastname(constraint(chat.getLastName()) ? Messages.PARAMETER_NOT_EXISTS_MESSAGE : chat.getLastName());
